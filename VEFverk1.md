...
Server-side forskriftarþarfir er tækni sem notuð eru í þróun vefur sem felur Starfsmenn þess forskriftir á vefþjóni sem framleiða svar sérsniðin fyrir (viðskiptavinarins) beiðni hvers notanda á vefsvæðið. The val er fyrir vefþjón sig til að skila truflanir vefsíðu. Forskriftir geta vera skrifaður í einhverju fjölda framreiðslumaður-hlið forskriftarþarfir tungumál sem eru í boði. Server-hlið forskriftarþarfir er að greina frá client-megin forskriftarþarfir þar innbyggð forrit, ss JavaScript, eru rekin client-megin í vafranum, en báðir aðferðir eru oft notuð saman.
